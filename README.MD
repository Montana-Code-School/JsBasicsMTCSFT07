...
Exercise 15:
//Write a javascript function that randomly returns either the integers 0, 1, or 2. Using this return value and an html button, switch the background image between 3 images. 
